      ...
      <div class="p-3 pb-0 d-flex flex-wrap gap-2 align-items-center justify-content-between">
        <div class="d-flex flex-grow-1 gap-2">
          ...
          <div class="input-group">
            <input type="text" id="searchColaboradores" class="form-control" placeholder="Busque por nome ou CPF" />
        ...
        <div class="custom-table-container">
          <div class="table-responsive">
            <table class="table custom-table" id="personsTable">
              ...
              <tr class="clickable-row" data-url="{{ route('Perfil Candidato', Crypt::encryptString($person['id_person'])) }}" style="cursor: pointer;">

                <td>{{ $person['full_name'] }}</td>
                <td>{{ $person['created_at'] }}</td>
                <td>{{ $person['result_name'] }}</td>
                <td>{{ $person['cidadeestado'] }}</td>
                <td>{{ $person['countvagas'] }}</td>
                <td>       <i class="ti ti-star-filled text-warning"></i>
        <i class="ti ti-star-filled text-warning"></i>
        <i class="ti ti-star-filled text-secondary"></i></td>
                <td>
                  <div class="dropdown">
